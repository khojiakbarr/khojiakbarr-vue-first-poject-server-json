  ...
  <section class="pt-20 md:pt-40 bg-gray-800 min-h-screen">
    <div class="container mx-auto px-8 lg:flex">
      <div class="text-center lg:text-left lg:w-1/2">
        <h1
          class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none text-white"
        >
          Todo
        </h1>
        <p class="text-xl lg:text-2xl mt-6 font-light text-white">
          Countless productivity apps and sites store your tasks in their own
          proprietary database and file format. But you can work with your
          todo.txt file in every text editor ever made, regardless of operating
          system or vendor.
        </p>
        ...
        <p class="mt-4 text-gray-600">
          You're not going to find many checkboxes, drop-downs, reminders, or
          date pickers here.
        </p>
      </div>
      <div class="lg:w-1/2">
